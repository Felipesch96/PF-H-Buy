...
const Filters = () => {
	...
	return (
		<div>
			<div id="sidebar" className="col-12 d-flex flex-column border max-height-sidebar py-2 text-center rounded mb-4">
					...
					<div className="col-lg-12 col-sm-6 col-12">
						<div >
							...
							<div class="d-flex justify-content-center">
								...
								<div>
									<input className='form-control' type="text" placeholerder="Buscar por nombre" name="filter-by-name" onChange={handleFilterInput} ></input>
								</div>
